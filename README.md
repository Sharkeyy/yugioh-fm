...
- Inspiration: Dieses Projekt ist inspiriert von [`falsepopsky/YGO-FM-Database`](https://github.com/falsepopsky/YGO-FM-Database).
- Danke an **falsepopsky und die darin beteiligten Personen** für die Vorarbeit/Idee und das Bereitstellen einer hilfreichen Datenbasis.
